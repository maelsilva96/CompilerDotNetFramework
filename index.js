...
try {
    ...
    const resultGetLastMsBuild = async () => {
    ...
    const resultRemoveBuildFolder = async () => {
        return await exec.exec('rmdir /Q /S C:\\_build');
    }
    console.log(`Result Remove Build Folder: ${resultRemoveBuildFolder}, command: rmdir /Q /S C:\\_build`);

    const resultRemoveAppFolder = async () => {
        return await exec.exec('rmdir /Q /S C:\\App');
    }
